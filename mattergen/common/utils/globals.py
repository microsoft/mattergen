...
PROPERTY_SOURCE_IDS = [
    "formation_energy_per_atom",        # 形成エネルギー
    "chemical_system",                  # 化学組成
    "host_chemical_system",             # 化学組成（ホスト化合物）
    "intercalant_chemical_system",      # 化学組成（インターカラント原子）
    "space_group",                      # 空間群
    "dft_band_gap",                     # DFTバンドギャップ
    "dft_mag_density",                  # 磁性密度
    "dft_bulk_modulus",                 # 体積弾性率
    "dft_shear_modulus",                # 剪断弾性率
    "energy_above_hull",                # ヒュールエネルギー
    "hhi_score",                        # HHIスコア
    "ml_bulk_modulus",                  # 機械学習体積弾性率
    "intercalation_energy_per_atom",    # インターカレーションエネルギー
]
